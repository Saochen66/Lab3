...
public class AppQueryBridgeWordsTest_TC5 {
  ...
  @Test
  public void testInvalidWord2NotInGraph() {
    String result = App.queryBridgeWords("a", "missing");
    System.out.println("TC5 actual: " + result);
    assertTrue(result.contains("No \"a\" or \"missing\" in the graph!"));
  }
}
